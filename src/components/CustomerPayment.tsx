...
import CustomerPaymentAppBar from './CustomerPaymentAppBar';
import CustomersPaymentTable from './CustomersPaymentTable';
...
const CustomerPayment = () => {
  ...
  return (
   ...
   <Search sx={{display: { xs: "none", md: "flex"  }}}>
    ...
    <CustomersPaymentTable busquedaPagos={busquedaPagos}/>
   </>
  )
}
